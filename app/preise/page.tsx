...
const texts: Record<string, Record<string, string>> = {
  ...
  hi: { title: "कीमतें", subtitle: "1 महीना मुफ्त – फिर लचीला मासिक रद्दीकरण", basic: "बेसिक", pro: "प्रो", business: "बिजनेस", perMonth: "/महीना", basic1: "ऑनलाइन बुकिंग", basic2: "ईमेल रिमाइंडर", basic3: "छोटी प्रैक्टिस के लिए", pro1: "बेसिक से सब कुछ", pro2: "समीक्षा प्रबंधन", pro3: "बढ़ती प्रैक्टिस के लिए", bus1: "प्रो से सब कुछ", bus2: "रद्दीकरण + प्रतीक्षा सूची", bus3: "बड़ी प्रैक्टिस के लिए", start: "मुफ्त शुरू करें", freeMonth: "1 महीना मुफ्त", allInclude: "सभी प्लान में शामिल:", include1: "असीमित बुकिंग", include2: "ईमेल रिमाइंडर", include3: "GDPR अनुपालन", include4: "SSL एन्क्रिप्शन", include5: "मुफ्त अपडेट", faqTitle: "सामान्य प्रश्न", faq1q: "क्या पहला महीना सच में मुफ्त है?", faq1a: "हां! आप बिना किसी बाध्यता के 1 महीने तक सभी सुविधाओं का परीक्षण कर सकते हैं। कोई छिपी हुई लागत नहीं।", faq2q: "क्या मैं कभी भी रद्द कर सकता हूं?", faq2a: "हां, मासिक रद्दीकरण संभव है। कोई लंबी अनुबंध शर्तें नहीं।", faq3q: "कौन सा प्रैक्टिस सॉफ्टवेयर समर्थित है?", faq3a: "PraxisOnline24 सभी सामान्य प्रैक्टिस प्रबंधन प्रणालियों के साथ काम करता है।", trustTitle: "आपका डेटा सुरक्षित है", back: "← होम पर वापस जाएं" },
}
...
export default function PreisePage() {
  ...
  const handleCheckout = (plan: string) => {
    ...
    const stripeLocale = (lang === "ar" || lang === "hi") ? "en" : lang
