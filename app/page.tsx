      ...
      <section className="py-8 sm:py-16 px-3 sm:px-6 text-center bg-blue-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <span className="bg-blue-100 border border-blue-200 rounded-full px-4 py-2 text-sm">✓ Praxisverwaltungssysteme</span>
            <span className="bg-blue-100 border border-blue-200 rounded-full px-4 py-2 text-sm">✓ Kassenärztliche Vereinigung</span>
            <span className="bg-blue-100 border border-blue-200 rounded-full px-4 py-2 text-sm">✓ TI-Konnektor</span>
            <span className="bg-blue-100 border border-blue-200 rounded-full px-4 py-2 text-sm">✓ E-Rezept-Fachdienst</span>
          </div>
        </div>
      </section>
