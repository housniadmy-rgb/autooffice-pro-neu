...
export default function Home() {
  ...
  <a href={l("registrieren")} className="bg-[#1E40AF] text-white text-sm sm:text-lg font-semibold px-6 sm:px-10 py-3 sm:py-4 rounded-full hover:bg-gray-100 transition shadow-lg">{t.start}</a>
  ...
  <a href="/termin-buchen" className="border-2 border-white text-white text-sm sm:text-lg font-semibold px-6 sm:px-10 py-3 sm:py-4 rounded-full hover:bg-white hover:text-[#1E40AF] transition">{t.bookAppointment}</a>
</div></div></section>
