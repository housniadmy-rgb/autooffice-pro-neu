...
const texts: Record<string, any> = {
  de: { title: "❓ Häufige Fragen (FAQ)", back: "← Zurück", q1: "Ist PraxisOnline24 sicher?", a1: "Ja! DSGVO-konform, alle Daten verschlüsselt auf EU-Servern.", q2: "Wie einrichten?", a2: "5 Min: Registrieren, Paket wählen, Link teilen. Fertig!", q3: "Kündigungsfrist?", a3: "Jederzeit kündbar, keine Mindestlaufzeit.", q4: "Paket wechseln?", a4: "Jederzeit möglich. Änderung ab nächster Abrechnung.", q5: "Patientendaten sicher?", a5: "Ja, nur Name/E-Mail, EU-Server, kein Datenverkauf." },
  en: { title: "❓ FAQ", back: "← Back", q1: "Is PraxisOnline24 safe?", a1: "Yes! GDPR-compliant, encrypted, EU servers.", q2: "How to set up?", a2: "5 min: Register, choose plan, share link. Done!", q3: "Cancellation?", a3: "Cancel anytime, no minimum term.", q4: "Change plan?", a4: "Anytime. Change takes effect next billing cycle.", q5: "Patient data safe?", a5: "Yes, name/email only, EU servers, no data sales." },
