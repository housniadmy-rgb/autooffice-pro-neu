...
const texts: Record<string, any> = {
  ...
  en: { title: "Terms", back: "← Back", p1:"1. Scope",t1:"These terms apply between PraxisOnline and users.", p2:"2. Contract",t2:"SaaS for online booking for medical practices.", p3:"3. Prices",t3:"49€/89€/199€ per month. Payment via Stripe.", p4:"4. Cancellation",t4:"Cancellable anytime. End of period.", p5:"5. Liability",t5:"Intent and gross negligence only.", p6:"6. Privacy",t6:"GDPR-compliant. See privacy policy.", p7:"7. Misc.",t7:"German law. Jurisdiction: Musterstadt." },
  ...
  es: { title: "Términos", back: "← Volver", p1:"1. Ámbito",t1:"Estos términos aplican entre PraxisOnline y usuarios.", p2:"2. Contrato",t2:"SaaS de reservas para consultas médicas.", p3:"3. Precios",t3:"49€/89€/199€ al mes. Pago por Stripe.", p4:"4. Cancelación",t4:"En cualquier momento. Fin del período.", p5:"5. Responsabilidad",t5:"Solo dolo y negligencia grave.", p6:"6. Privacidad",t6:"Conforme RGPD.", p7:"7. Varios",t7:"Derecho alemán. Jurisdicción: Musterstadt." },
  ...
  ja: { title: "利用規約", back: "← 戻る", p1:"1. 適用範囲",t1:"本規約はPraxisOnlineと利用者間で適用されます。", p2:"2. 契約",t2:"医療機関向けオンライン予約SaaS。", p3:"3. 料金",t3:"月額49€/89€/199€。Stripe決済。", p4:"4. 解約",t4:"いつでも解約可能。期間終了時に有効。", p5:"5. 責任",t5:"故意および重大な過失のみ。", p6:"6. プライバシー",t6:"GDPR準拠。", p7:"7. その他",t7:"ドイツ法。管轄: Musterstadt。" },
  zh: { title: "条款", back: "← 返回", p1:"1. 范围",t1:"本条款适用于PraxisOnline与用户之间。", p2:"2. 合同",t2:"面向诊所的在线预约SaaS。", p3:"3. 价格",t3:"每月49€/89€/199€。Stripe支付。", p4:"4. 取消",t4:"随时可取消。周期结束时生效。", p5:"5. 责任",t5:"仅限故意和重大过失。", p6:"6. 隐私",t6:"符合GDPR。", p7:"7. 其他",t7:"德国法律。管辖地: Musterstadt。" },
  cs: { title: "Podmínky", back: "← Zpět", p1:"1. Rozsah",t1:"Tyto podmínky platí mezi PraxisOnline a uživateli.", p2:"2. Smlouva",t2:"SaaS pro online rezervace pro ordinace.", p3:"3. Ceny",t3:"49€/89€/199€ měsíčně. Platba Stripe.", p4:"4. Zrušení",t4:"Kdykoli. Účinnost na konci období.", p5:"5. Odpovědnost",t5:"Pouze úmysl a hrubá nedbalost.", p6:"6. Soukromí",t6:"GDPR.", p7:"7. Ostatní",t7:"Německé právo. Soud: Musterstadt." },
  sk: { title: "Podmienky", back: "← Späť", p1:"1. Rozsah",t1:"Tieto podmienky platia medzi PraxisOnline a používateľmi.", p2:"2. Zmluva",t2:"SaaS pre online rezervácie pre ordinácie.", p3:"3. Ceny",t3:"49€/89€/199€ mesačne. Platba Stripe.", p4:"4. Zrušenie",t4:"Kedykoľvek. Účinnosť na konci obdobia.", p5:"5. Zodpovednosť",t5:"Len úmysel a hrubá nedbalosť.", p6:"6. Súkromie",t6:"GDPR.", p7:"7. Ostatné",t7:"Nemecké právo. Súd: Musterstadt." },
