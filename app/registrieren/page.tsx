...
const texts: Record<string, any> = {
  ...
  hi: { title: "रजिस्टर", name: "नाम", email: "ईमेल", password: "पासवर्ड", dsgvo: "मैं सहमत हूं", dsgvoLink: "गोपनीयता नीति", registerBtn: "खाता बनाएं", loading: "रजिस्टर हो रहा है...", hasAccount: "पहले से खाता है?", login: "लॉगिन करें", success: "रजिस्ट्रेशन सफल!", back: "← वापस", dsgvoError: "कृपया गोपनीयता नीति स्वीकार करें।" },
    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4 sm:p-8">
      <div className="bg-white border border-blue-200 shadow-lg p-6 sm:p-10 rounded-xl max-w-md w-full">
        ...
        <form onSubmit={handleRegister} className="space-y-4 sm:space-y-5">
          ...
          <button type="submit" disabled={loading} className="w-full bg-[#1E40AF] text-white text-lg sm:text-xl font-semibold py-3 sm:py-4 rounded-lg hover:bg-blue-800 transition disabled:opacity-50 cursor-pointer">{loading ? t.loading : t.registerBtn}</button>
        </form>
