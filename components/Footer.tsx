...
const texts: Record<string, any> = {
  ...
  pl: { ueberUns: "O nas", kontakt: "Kontakt", blog: "Blog", dsgvo: "Prywatność", impressum: "Nota prawna", admin: "Admin" },
  ...
  cs: { ueberUns: "O nás", kontakt: "Kontakt", blog: "Blog", dsgvo: "Ochrana údajů", impressum: "Impressum", admin: "Admin" },
  sk: { ueberUns: "O nás", kontakt: "Kontakt", blog: "Blog", dsgvo: "Ochrana údajov", impressum: "Impressum", admin: "Admin" },
  sl: { ueberUns: "O nas", kontakt: "Kontakt", blog: "Blog", dsgvo: "Zasebnost", impressum: "Impressum", admin: "Admin" },
